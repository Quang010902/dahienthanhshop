...
function DetailHistory(props) {
    ...
    return (
        <div className="container">
                ...
                <div className="container">
                    <div className="row px-4 px-lg-5 py-lg-4 align-items-center">
                        <div className="col-lg-6">
                            <h1 className="h2 text-uppercase mb-0">Chi tiết đơn</h1>
                        </div>
            ...
            <div className="p-5">
                <h1 className="h2 text-uppercase">Thông tin đơn</h1>
                <p>ID User: {information.idUser}</p>
                <p>Họ tên: {information.fullname}</p>
                <p>Số điện thoại: {information.phone}</p>
                <p>Địa chỉ: {information.address}</p>
                <p>Tổng: {information.total}$</p>
            </div>
