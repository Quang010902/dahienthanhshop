                        ...
                        <div className="row align-items-stretch mb-4">
                            ...
                            <div className="col-sm-3 pl-sm-0">
                                <a className="btn btn-dark btn-sm btn-block d-flex align-items-center justify-content-center px-0 text-white"
                                    onClick={addToCart} >Thêm vào giỏ hàng</a>
                            </div>
                            <a className="btn btn-link text-dark p-1 mb-4" href="#">
                                <i className="far fa-heart mr-2"></i>Thêm vào danh sách mong muốn
                        </a>
                            <br></br>
                            <ul className="list-unstyled small d-inline-block">
                                ...
                                <li className="px-3 py-2 mb-1 bg-white text-muted"><strong className="text-uppercase text-dark">Danh mục:</strong><a className="reset-anchor ml-2">{detail.category}s</a></li>
                                <li className="px-3 py-2 mb-1 bg-white text-muted"><strong className="text-uppercase text-dark">Tags:</strong><a className="reset-anchor ml-2">Sự đổi mới</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                        ...
                        review === 'description' ? (
                            <div className="tab-pane fade show active">
                                <div className="p-4 p-lg-5 bg-white">
                                    <h6 className="text-uppercase">Chi tiết sản phẩm </h6>
                                    ...
                                    <div className="d-block mb-3 position-relative">
                                        ...
                                        <div className="product-overlay">
                                            <ul className="mb-0 list-inline">
                                                ...
                                                <li className="list-inline-item m-0 p-0"><a className="btn btn-sm btn-dark text-white">Thêm vào giỏ hàng</a></li>
                                            </ul>
                                        </div>
                                    </div>
